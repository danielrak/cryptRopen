...
input size. The `chunk_size` argument controls the row count per
chunk; the default (`1e6`) is a reasonable trade-off between memory
footprint and per-chunk overhead.
