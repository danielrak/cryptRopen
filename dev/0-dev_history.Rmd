...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Industrialized datasets encryption (open-source version)",
    Description = "This package provides a framework to encrypt
    variables from datasets. Variables to encrypt and datasets 
    can be in any number.",
    `Authors@R` = c(
      person("Daniel", "Rakotomalala", email = "rakdanielh@gmail.com", 
             role = c("aut", "cre"))
    )
  )
)
...
# Code of Conduct
usethis::use_code_of_conduct("opensource@data.gouv.fr")
# NEWS
usethis::use_news_md()
```
